...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light d-flex justify-content-between">
                ...
                <div class="container my-5" style="">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <h1>JAPAN</h1>
                            <div class="card shadow-lg bg-white rounded custom_card">
                                <img id="cardImage" class="img-fluid rounded" src="https://asti.dost.gov.ph/pedro/img/no-image.png">
                                <div class="card-body">
                                    <div class="weather loading">
                                        <h2 class="city text-center"></h2>
                                        <div class="text-center d-flex justify-content-around align-items-center">
                                            <h2 class="temp mr-2"></h2>
                                            <img src="{{ url('svg/temperature-svgrepo-com.svg') }}" height="50" alt="" class="" />
                                        </div>
                                        <div class="d-flex justify-content-around align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <img src="{{ url('svg/humidity-svgrepo-com.svg') }}" height="50" alt="" class="icon" />
                                                <div class="humidity mt-3 text-center"></div>
                                            </div>
                                            <div class="d-flex flex-column">
                                                <img src="{{ url('svg/windy-svgrepo-com.svg') }}" height="50" alt="" class="icon" />
                                                <div class="wind mt-3 text-center"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Japan&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://putlocker-is.org"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:100%;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:100%;}</style></div></div>

        <div class="call_to_action mt-5">
            <center>
        ...
        <div class="embed-responsive embed-responsive-16by9">
            <iframe width="956" height="538" src="https://www.youtube.com/embed/IuTDuvYr7f0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
